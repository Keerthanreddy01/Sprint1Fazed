...
class _FilloraAppState extends State<FilloraApp> with WidgetsBindingObserver {
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      // Minimum splash duration to ensure smooth transition from native splash
      ...
      if (mounted) {
        ...
        // Smooth fade out - give time for Flutter splash to show
  ...
  Future<void> _loadPreferences() async {
    try {
      ...
      setState(() {
        _currentTheme = prefs.getString('theme') ?? 'dark'; // Default to dark theme
      });
